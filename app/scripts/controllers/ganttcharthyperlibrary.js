...
angular.module(
    ...
    function($scope) {
        ...
        var columns = DlhSoft.Controls
            .GanttChartView.getDefaultColumns(
                items, settings);
        var indexOffset = columns[0]
            .isSelection ? 1 : 0;
